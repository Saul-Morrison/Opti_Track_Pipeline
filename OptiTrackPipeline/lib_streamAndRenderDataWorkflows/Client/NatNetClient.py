...
class NatNetClient:
    ...
    def __unpack_skeleton( self, data, major, minor):
        ...
        # if self.skeleton_listener is not None:
        #     self.skeleton_listener(skeleton)
...
#Unpack Mocap Data Functions
    ...
    def __process_message( self, data : bytes, print_level=0):
        ...
        if message_id == self.NAT_FRAMEOFDATA :
            ...
            DataStreamer.dumpFrameDataIntoSharedMemory(simulate=False,sharedMemArray=self.shared_array,mocapData=mocap_data,quaternionsUnit=quaternionsUnit)
            offset += offset_tmp
