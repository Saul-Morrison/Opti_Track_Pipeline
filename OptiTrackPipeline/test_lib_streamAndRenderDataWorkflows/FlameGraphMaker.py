...
target_script = "C:/Users/saulm/OneDrive/cambridge/IIB/IIB Project - Augmented Reality/Opti_Track_Pipeline/OptiTrackPipeline/VisualiseRigidData.py"

# Step 1: Run pyflame to capture stack traces
# The -o flag specifies the output file for the stack traces
with open("pyflame_output.txt", "w") as out_file:
    subprocess.run(["py-spy", "record", "-o", "py_spy_output.txt", "--rate", "100", "--format", "speedscope", "--", "python", target_script], check=True)
